...
export class AppConfigCreateConstruct extends Construct {
  ...
  constructor(scope: Construct, id: string) {
    ...
    // Output
    new CfnOutput(this, 'ApplicationOutput', {
      value: this.application.ref,
      description: 'AppConfig Application ID',
      exportName: 'appconfig-application-id'
    });
    new CfnOutput(this, 'ConfigurationProfileOutput', {
      value: this.confProfile.ref,
      description: 'AppConfig Configuration Profile ID',
      exportName: 'appconfig-configuration-profile-id'
    });
    new CfnOutput(this, 'DevEnvironment', {
      value: this.devEnv.ref,
      description: 'AppConfig Dev Environment ID',
      exportName: 'appconfig-dev-environment-id'
    });
    new CfnOutput(this, 'DevHostedConfigurationVersion', {
      value: this.devHostedConf.ref,
      description: 'AppConfig Dev Hosted Configuration Version ID',
      exportName: 'appconfig-dev-hosted-configuration-id'
    });
  }
}
